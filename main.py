...
# Botões
    # linha 1
b_1 = Button(frame_corpo, command= limpar_tela, text="C", width=16, height=2, bg=cor4, font=("Ivy 13 bold"), relief=RAISED, overrelief=RIDGE)
b_1.place(x=0, y=0)
...
b_7 = Button(frame_corpo, command= lambda: valores('*'), text="*", width=5, height=2, bg=cor5, font=("Ivy 13 bold"), relief=RAISED, overrelief=RIDGE)
...
b_11 = Button(frame_corpo, command= lambda: valores('-'), text="-", width=5, height=2, bg=cor5, font=("Ivy 13 bold"), relief=RAISED, overrelief=RIDGE)
...
b_15 = Button(frame_corpo, command= lambda: valores('+'), text="+", width=5, height=2, bg=cor5, font=("Ivy 13 bold"), relief=RAISED, overrelief=RIDGE)
